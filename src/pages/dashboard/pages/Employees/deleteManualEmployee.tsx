...
type DeleteType={
  employeeName:string,
  employeeId:string,
    employeeArrayId:string
}
const DeleteManualEmployee = (props:DeleteType) => {
    const queryClient = useQueryClient();
    const {employeeId,employeeArrayId}=props
    ...
    const handleDelete=()=>{
        try{
            RemoveEmployee({userId:employeeId,employeeId:employeeArrayId})
        }
        catch(err){
...
export default DeleteManualEmployee